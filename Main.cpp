...
int main()
{
    ...
    //overlap("/home/zhujie/Cuda/data/back.bmp","/home/zhujie/Cuda/data/front.bmp","/home/zhujie/Cuda/data/overlap_cpu.bmp",tran);
    ...
    cout<<"Total time:"<<c.time()<<"us"<<endl;
    return 0;
}
/**
 * 替换图片中的指定颜色为其他颜色
